...
<template>
  <nav class="site-nav" text-xl>
    <router-link class="yun-icon-btn" to="/" :title="t('menu.home')">
      <!-- <div i-ri-home-4-line /> -->
      Home
    </router-link>

    <router-link class="yun-icon-btn" to="/archives/" :title="t('menu.archives')">
    ...
    <app-link class="yun-icon-btn" :to="themeConfig.menu.custom.url" :title="t(themeConfig.menu.custom.title)">
